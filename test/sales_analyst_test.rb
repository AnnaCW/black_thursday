...
#   end
  ...
  def test_it_finds_total_revenue_by_date_when_all_dates_included
    assert_equal 71832.0, sa2.total_revenue_by_date(Time.parse("2013-03-27 14:54:09 UTC")).to_f*100
  end

  def test_it_finds_total_revenue_by_date
    assert_equal 13635.0, sa2.total_revenue_by_date(Time.parse("2012-04-27 14:54:09 UTC")).to_f*100
  end
